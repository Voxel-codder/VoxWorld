...
main-notice =
    ...
    - Vox WorldはGPL 3のオープンソースライセンスの下に提供されています。つまり、あなたはゲームを自由に遊んだり、改造したりコピーできます
     （派生した作品もGPL 3の下ならばという条件でです）

    - Vox Worldは非営利のコミュニティプロジェクトで、作業をしている人も全員、無償のボランティアです。
...
loading-tips =
    ...
    .a5 = /groupまたは/gと入力すると現在所属しているグループのプレイヤーとだけチャットできます。
    .a6 = プライベートメッセージを送るには、/tellと入力したあと、プレイヤー名とメッセージを入力します。
    .a7 = 世界中に散らばっている食料やチェストに注目してみましょう！
    .a8 = 持ち物が食料でいっぱいですか？それを使ってもっといい食料をクラフトしてみましょう！
    .a9 = 何をしたらいいかわからないですか？地図にあるダンジョンに挑戦してみましょう！
    .a10 = お使いのシステムに合わせてグラフィックの調整もお忘れなく。{ $gameinput-settings }キーを押すと設定が開きます。
    .a11 = 誰かと一緒に遊ぶのは楽しいですよね！{ $gameinput-social }キーを押すと誰がオンラインかわかります。
    .a12 = { $gameinput-dance }キーを押すとダンスします。パーティ！
    .a13 = { $gameinput-glide }キーを押すとグライダーが開いて空を攻略できます。
    .a14 = Vox Worldは、まだアルファ版です。私たちは日々、改善のためにベストを尽くしています！
