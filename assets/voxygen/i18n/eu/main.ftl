...
main-notice =
    Ongi etorri Vox World alpha bertsiora!
    ...
    - Vox World GPL-3 lizentzia librean banatzen da. Horrek esan nahi du libre zarela jokatu, aldatu eta nahi bezala banatzeko (betiere GPL-3 lizentziaren baldintzak betetzen badituzu)

    - Vox World irabazi asmorik gabeko proiektua da, eta guztiok bertan modu boluntarioan egiten dugu lan.
...
loading-tips =
    ...
    .a9 = Ez dakizula zer egin? Bisitatu mapan markatutako ziegak!
    .a10 = Ez ahaztu ezarpen grafikoak zure sistemara egokitzea. Sakatu 'N' ezarpenak irekitzeko.
    ...
    .a14 = Vox World oraindik Pre-Alpha bertsioan dago. Ahalegin handia egiten dugu egunero hobetzeko!
