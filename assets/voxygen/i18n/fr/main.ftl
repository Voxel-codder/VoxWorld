...
main-notice =
    Bienvenue dans la version alpha de Vox World !
    ...
    - Vox World est un jeu open source. Vous êtes libre de jouer, de modifier et de redistribuer le jeu conformément à la version 3 de la licence publique générale GNU.

    - Vox World est un projet communautaire à but non-lucratif développé par des bénévoles.
...
loading-tips =
    ...
    .a14 = Vox World est encore en pré-alpha. Nous faisons de notre mieux pour l'améliorer chaque jour !
