...
hud-trade-tooltip_hint_1 = <Maj-Clique pour ajouter/retirer de l'échange.>
hud-trade-tooltip_hint_2 = <Ctrl-Clique pour égaliser automatiquement la valeur avec ceci.>
...
hud-trade-invite-accepted = { $target } a accepté votre demande d'échange.
hud-trade-invite-timed_out = La demande d'échange avec { $target } a expiré.
hud-trade-player_who = Joueur { $player_who }
