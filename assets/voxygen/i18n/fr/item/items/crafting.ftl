...
sprite-crafting_ing-pearl = Perle
    .desc = Pourrait faire une belle lampe.
...
sprite-rocks-rock-0 = Pierres
    .desc = Des cailloux trouvés par terre, rien d'extraordinaire.
...
sprite-flowers-pyrebloom = Gazania ardente
...
object-v-coin = Vcoin
    .desc = Monnaie utilisée dans Vox World.
...
sprite-crafting_ing-bloody_tear = Larme de sang
    .desc = Le sang durci et concentré des innombrables victimes des bêtes.
sprite-crafting_ing-molten_core = Cœur en fusion
    .desc = Une lame liquid compactée, forgée dans le grand fourneau de la terre.
sprite-crafting_ing-hide-serpent_scale = Écaille de serpent
    .desc = Des écailles tranchantes comme des rasoirs, coupant quiconque ose les toucher.
sprite-crafting_ing-bloodbag = Poche de sang
    .desc = Une poche remplie de sang.
sprite-velorite-lodestone = Magnétite
    .desc = Une pierre cristalline semblant légèrement magnétique.
object-consumable-firedrop = Pyrogoutte
    .desc = Un échantillon visqueux d'un liquide inflammable.
object-consumable-poison_clot = Caillot empoisonné
    .desc = Un petit morceau de poison concentré.
object-consumable-gelid_gel = Gel frigorifique
