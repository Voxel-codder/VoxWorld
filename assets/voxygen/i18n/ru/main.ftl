...
main-notice =
    Добро пожаловать в альфа-версию Vox World!

    Прежде чем начать веселиться, пожалуйста, имейте в виду несколько вещей:

    - Это очень ранняя альфа. Ожидайте ошибок, незавершенного геймплея, незавершенных механик или отсутствующих функций.

    - Если вы желаете оставить отзыв или сообщить об ошибке, вы можете связаться с нами через Reddit, GitLab или наш сервер Discord.

    - Vox World - это проект с открытым исходным кодом. Это означает, что вы можете изменять и распространять игру в рамках лицензии GPL 3.

    - Vox World - это некоммерческий общественный проект, и все, кто работает над ним, являются добровольцами.
    Если вам нравится данный проект, вы можете присоединиться к нашей команде единомышленников!

    Спасибо, что уделили время прочтению данного сообщения. Мы надеемся, что вам понравится игра!

    ~ Разработчики Vox World
main-login_process =
    Информация касаемо многопользовательского режима:

    Имейте ввиду то, что вам необходимо иметь аккаунт Vox World чтобы играть на серверах с включенной аутентификацией

    Вы можете создать учетную запись по данной ссылке:
    странице аккаунта Vox World
...
main-login-insecure_auth_scheme = Аутентификация по HTTP не поддерживается. Это небезопасно! В целях разработки, HTTP разрешен для локального подключения или отладочных сборок.
main-login-server_full = Сервер заполнен.
main-login-untrusted_auth_server = Сервер аутентификации не является доверенным.
main-login-timeout = Время ожидания подключения к серверу превышено. Возможно, сервер перегружен или имеются проблемы с сетью.
main-login-server_shut_down = Сервер выключен.
main-login-network_error = Ошибка сети.
main-login-network_wrong_version = Версия клиента не соответствует версии сервера. Пожалуйста, обновите свой игровой клиент.
...
main-login-client_crashed = Сбой игрового клиента.
main-login-not_on_whitelist = Вы не были добавлены в вайтлист сервера и не можете присоединиться.
main-login-banned = Вы получили бессрочную блокировку по причине: { $reason }
main-login-kicked = Вас выгнали с сервера по следующей причине: { $reason }
...
loading-tips =
    ...
    .a14 = Vox World все еще находится в Пре-Альфе. Мы делаем всё возможное, чтобы улучшать его каждый день!
...
main-singleplayer-map_large_warning = Внимание: Для первого запуска больших миров потребуется много времени.
...
main-singleplayer-map_shape-circle = Окружность
main-singleplayer-map_shape-square = Квадрат
main-server-rules-seen-before = Правила были изменены. Необходимо повторное подтверждение.
main-login-banned_until =
    Вы получили временную блокировку по следующей причине: { $reason }
    Время окончания блокировки: { $end_date }
main-server-rules = На этом сервере есть правила, с которыми необходимо согласиться.
main-singleplayer-map_large_extra_warning = Это потребует примерно столько же ресурсов, сколько и генерация { $count } миров с настройками по умолчанию.
