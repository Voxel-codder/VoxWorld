...
main-notice =
    ...
    Welcome to the alpha version of Vox World!
    ...
    - Vox World is licensed under the GPL 3 open-source licence. That means you're free to play, modify, and redistribute the game however
     you wish (provided derived work is also under GPL 3).

    - Vox World is a non-profit community project, and everybody working on it is a volunteer.
...
main-login-server_not_found =
    ไม่พบเซิร์ฟเวอร์ 
    Server not found
main-login-authentication_error =
    ยินยันรหัสผิดพลาด
    Auth error on server
main-login-internal_error =
    เกิดข้อผิดพลาดขึ้นกับตัวเกม (ตัวละครอาจถูกลบไปแล้ว) 
...
main-login-insecure_auth_scheme =
    ไม่อนุญาตให้ยืนยันตัวตนผ่านรูปแบบ HTTP เนื่องจากความปลอดภัย อนุญาตให้ใช้ HTTP ก็ต่อเมื่อทำการดีบัคหรือเมื่อรันบน localhost เท่านั้น
...
main-login-server_shut_down =
    เซิร์ฟเวอร์ปิดอยู่
    Server shut down
main-login-network_error =
    เคลือข่ายขัดข้อง 
    Network error
main-login-network_wrong_version =
    เวอร์ชั่นของตัวเกมและเซิร์ฟเวอร์ไม่ตรงกัน โปรดอัพเดทตัวเกม
...
main-login-invalid_character =
    ไม่สามารถเลือกตัวละครได้
    The selected character is invalid
main-login-client_crashed =
    ตัวเกมปิดตัวลงกระทันหัน
    Client crashed
main-login-not_on_whitelist =
    ต้องได้รับคำอนุญาตในการเชื่อมต่อเข้าเซิร์ฟเวอร์
...
main-login-client_init_failed =
    ไม่สามารถเริ่มตัวเกมได้ เนื่องจาก { $init_fail_reason }
...
main-servers-singleplayer_error =
    ไม่สามารถเข้าเล่มโหมดผู้เล่นคนเดียวได้ ข้อผิดพลาด:{ $sp_error }
    Failed to connect to internal server: { $sp_error }
main-servers-network_error =
    เกิดความผิดพลาดขึ้นกับเคลือข่าย ข้อผิดพลาด: { $raw_error }
    Server network/socket error: { $raw_error }
main-servers-participant_error =
    โปรโตคอลผิดพลาด ข้อผิดพลาด: { $raw_error }
    Participant disconnect/protocol error: { $raw_error }
main-servers-stream_error =
    เกิดข้อผิดพลาดกับการเชื่อมต่อ, การบีบอัดข้อมูล หรือการอ่านข้อมูล: { $raw_error }
    Client connection/compression/(de)serialization error: { $raw_error }
main-servers-database_error =
    ฐานข้อมูลของเซิร์ฟเวอร์ล้มเหลว ข้อผิดพลาด: { $raw_error }
    Server database error: { $raw_error }
main-servers-persistence_error =
    เซิร์ฟเวอร์ไม่สามารถรักษาข้อมูลได้ ข้อผิดพลาด: { $raw_error }
...
loading-tips =
    ...
    .a5 = ใช้คำสั่ง /group หรือ /g ในช่องสนทนาเพื่อพูดคุยกับผู้เล่นที่อยู่ในปาร์ตี้
    .a6 = อยากคุยกับใครเป็นการส่วนตัว ใช้คำสั่ง /tell ตามด้วยชื่อผู้เล่นและข้อความ เพื่อกระซิบ
    .a7 = อาหาร, ไห และกล่องสมบัติสามารถพบได้ทั่วไป ลองหาดูดี ๆ นะ
    .a8 = กระเป๋าเต็มเพราะอาหารเยอะใช่ไหม? ลองทำอาหารที่ดีกว่าจากอาหารที่มีอยู่สิ
    .a9 = นั่งว่าง ๆ ไม่มีอะไรทำหรอ? ลองไปตะลุยดันเจียนสักหน่อยไหมหล่ะ?
    .a10 = อย่าลืมตั้งค่ากราฟฟิกให้เหมาะสมกับหน้าจอของตัวเองนะ กด '{ $gameinput-settings }' เพื่อเปิดเมนูตั้งค่า
    .a11 = เล่นกับเพื่อนจะยิ่งสนุกกว่า กด '{ $gameinput-social }' เพื่อดูว่าเพื่อนคนไหนกำลังออนไลน์
    .a12 = กด '{ $gameinput-dance }' เพื่อเต้น ไหนเอาท่าเต้นมาดูหน่อยสิ!
    .a13 = กด '{ $gameinput-glide }' เพื่อใช้เครื่องร่อน วันนี้เราจะไปแตะขอบฟ้ากัน!
    .a14 = ถึงแม้ว่าเวโลเรนจะยังอยู่ในช่วง Pre-Aplha แต่พวกเราก็ตั้งใจพัฒนาเกมทุกวันนะ!
    .a15 = อยากมีส่วนร่วมในการพัฒนาเวโลเรนหรืออยากคุยกับทีมพัฒนาใช่ไหม มาเจอเราใน Discord สิ!
    .a16 = คุณสามารถปิดตัวเลขที่แสดงพลังชีวิตได้ด้วยการตั้งค่า
    .a17 = นั่งพักใกล้ ๆ แคมป์ไฟ (กด '{ $gameinput-sit }') เพื่อฟื้นฟูพลังชีวิตและความเหนื่อยล้า
    .a18 = ประสบปัญหากระเป๋าเต็มหรือเกราะไม่โหดพอใช่ไหม สร้างกระเป๋าและเกราะที่โหดขึ้นกว่าเดิมได้โดยการเปิดเมนูสร้างของ กด '{ $gameinput-crafting }'
    .a19 = กด '{ $gameinput-roll }' เพื่อหลบการโจมตีแบบดิจิทัล
    .a20 = ไม่แน่ใจว่าวัตถุในการสร้างของหาจากไหนหรอ? พิม 'input:<item name>' ในแถบด้านบนเพื่อดูวัตถุที่ต้องใช้
    .a21 = ถ่ายรูปเท่ห์ ๆ ไปอวดเพื่อนด้วย '{ $gameinput-screenshot }'
