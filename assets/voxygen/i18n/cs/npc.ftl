...
npc-response-quest-escort-ask =
    .a0 = Dovedeš mě do { $dst }? Zaplatím ti { $coins } Vcoin! Potřebuju se tam dostat do { $mins } minut!
    .a1 = Chci se do { $mins } minut dostat do { $dst }. Odvedeš mě tam za { $coins } Vcoin?
...
npc-response-quest-slay-ask =
    .a0 = Zdejší lidé jsou terorizovaní od { $body }! Musí zemřít! Zaplatím ti za to { $coins } Vcoin.
    .a1 = Ne daleko odsud se schovává { $body }. Takhle už nejde žít! { $coins } Vcoin, když to vyřešíš!
