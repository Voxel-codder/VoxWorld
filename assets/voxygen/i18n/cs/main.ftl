...
main-tip = Tip:
main-notice =
    Vítejte v alfa verzi Vox World!
    ...
    - Vox World je s otevřeným zdrojem. Můžete hrát, modifikovat a sdílet hru v souladu s Obecnou veřejnou licencí GNU v.3.

    - Vox World je neziskový projekt, kde je každý spolupracující člověk dobrovolníkem.Pokud se vám tato hra líbí, připojte se k našemu týmu!
...
loading-tips =
    ...
    .a14 = Vox World je stále v Pre-Alpha. Snažíme se hru zlepšit co to jde!
