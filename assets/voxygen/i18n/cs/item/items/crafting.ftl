...
sprite-rocks-rock-0 = Kámen
    .desc = Kamínky ze země, nic zvláštního.
sprite-twigs-twigs-0 = Větvička
    .desc = Válí se pod stromy, asi ji zlomila veverka.
...
object-v-coin = Vcoin
    .desc = Měna používaná ve Vox World.
...
sprite-crafting_ing-hide-serpent_scale = Hadí šupina
    .desc = Šupina ostrá jako břitva, která pořeže každého, kdo se odváží si sáhnout.
sprite-crafting_ing-bloodbag = Pytlík Krve
    .desc = Pytlík naplněný krví.
sprite-velorite-lodestone = Magnetovec
    .desc = Krystalická hornina, která bude nejspíš magnetická.
object-consumable-firedrop = Kapka Ohně
    .desc = Malý lepkavý kousek hořlaviny.
object-consumable-poison_clot = Sražený Jed
    .desc = Malá tabletka koncentrovaného jedu.
object-consumable-gelid_gel = Ledový Gel
    .desc = Lepkavé kousky gelu zabalené v ledovém vzduchu.
object-consumable-levin_dust = Levinův Prach
    .desc = Štiplavý prášek s přírodním magnetickým nábojem.
