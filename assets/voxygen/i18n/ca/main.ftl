...
main-notice =
    Benvingut a la versió alfa de Vox World!
    ...
    - Vox World està llicenciat sota una llicència de codi obert GPL 3. Això significa que ets lliure de jugar, modificar, i redistribuir el joc de la manera
     que desitges (sempre que aquest producte derivat es trobi sota una llicència GPL 3).

    - Vox World és un projecte comunitari sense ànim de lucre i tothom qui hi treballa en ell és un voluntari.
    ...
    ~ Els Desenvolupadors de Vox World
main-login_process =
    ...
    la pàgina de comptes de Vox World
...
loading-tips =
    ...
    .a14 = Vox World roman encara en estat pre-Alfa. Estem fent tot el possible per millorar-lo cada dia!
