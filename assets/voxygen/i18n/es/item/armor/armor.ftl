...
armor-misc-chest-shirt_white = Camisa de Trabajador Blanca
    .desc = Era utilizada por un campesino, hasta hace poco.
...
armor-misc-head-wanderers_hat = Sombrero del errante
    .desc = El sombrero perfecto para quienes se sienten en casa en las carreteras y caminos de Vox World.
...
armor-golemite-shoulder = Hombreras de Golemite
    .desc = Equipamiento construido a partir de Golemite, que proporciona resistencia similar a la de un gólem.
armor-mail-orichalcum-7 = Casco de oricalco
    .desc = La hoja brilla cuando entras en batalla.
