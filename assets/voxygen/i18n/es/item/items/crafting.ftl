...
object-v-coin = Vcoin
    .desc = Moneda utilizada en Vox World.
...
sprite-mineral-ore-ancient_gold = Oro antiguo
    .desc = Lingote ancestral de oro, empapado en energía mágica.
sprite-crafting_ing-dwarven_battery = Batería de los Enanos
    .desc = Un contenedor de energía mágica.
sprite-crafting_ing-cursed_bead = Perla Maldita
    .desc = ¿Qué oscuras magias podría albergar esta antigua perla mística?
sprite-crafting_ing-golem_core = Núcleo de Gólem
    .desc = Un misterioso núcleo mágico, capaz de alimentar una antigua construcción de guardián.
sprite-crafting_ing-earthern_shard = Fragmento Terrenal
    .desc = Un fragmento endurecido que alguna vez fue parte de un ser cerámico animado.
sprite-crafting_ing-golemite_slab = Lámina de Golemite
    .desc = Después de ser restaurado a su antigua gloria, este material terrenal se volvió resistente y adecuado para la producción de armaduras.
sprite-crafting_ing-alkahest = Alkahest
    .desc = Disolvente Alquímico.
sprite-crafting_ing-molten_core = Núcleo fundido
    .desc = Espada líquida compactada, forjada en el gran horno de la tierra.
sprite-crafting_ing-hide-serpent_scale = Escama de serpiente
    .desc = Escamas afiladas como cuchillas que cortan a quien se atreva a tocarlas.
sprite-crafting_ing-bloodbag = Bolsa de sangre
    .desc = Una bolsa llena de sangre.
sprite-velorite-lodestone = Magnetita
    .desc = Roca cristalina que parece tener un ligero magnetismo.
object-consumable-firedrop = Firedrop
    .desc = Pequeña pieza viscosa de combustible inflamable.
object-consumable-poison_clot = Coágulo venenoso
    .desc = Un pequeño grano de veneno concentrado.
object-consumable-gelid_gel = Gel Gélido
    .desc = Pedazos adhesivos de gel rellenos de aire refrigerado.
object-consumable-levin_dust = Polvo Levin
    .desc = Polvo hormigueante, con una carga magnética natural.
sprite-crafting_ing-bloody_tear = Lágrima sangrienta
    .desc = La sangre endurecida y concentrada de las innumerables víctimas de las bestias.
