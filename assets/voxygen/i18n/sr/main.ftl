...
main-tip = Савет:
main-notice =
    Добродошао/ла у алфа верзију Vox World!
    ...
    - Vox World је лиценциран под GPL 3 лиценцом отвореног кода. Што значи да можеш да играш, мењаш, и раздељујеш игру како код пожелиш (ако је изведена дорада такође под GPL 3 лиценцом).

    - Vox World је не профитни пројекат заједнице, и сви који раде на њему су добровољци.
...
loading-tips =
    ...
    .a14 = Vox World је и даље Пре-Алфа. Сваким даном се трудимо да га побољшамо!
