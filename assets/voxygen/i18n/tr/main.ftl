...
main-tip = İpucu:
main-notice =
    Vox World Alfa sürümüne hoşgeldin!
    ...
    - Vox World GPL 3 açık kaynak lisansı ile lisanslıdır. Bunun anlamı, oyunu istediğin gibi oynayabilir, değiştirebilir ve dağıtabilirsin
    (türetilmiş çalışmalarda GPL 3 ile lisanslanmış olduğu sürece)

    - Vox World kar gütmeyen bir topluluk projesidir ve üzerinde çalışan herkes birer gönüllüdür.
...
loading-tips =
    ...
    .a5 = Aynı seviyedeki NPCler farklı zorluklara sahip olabilir.
    .a6 = Yemek, sandık ve diğer ganimetler için yere bak!
    .a7 = Envanterin yemekle mi dolu? Onları kullanarak daha iyi yemek yapmaya çalış!
    .a8 = Ne yapabileceğini merak mı ediyorsun? Zindanlar haritada kahverengi bölgeler olarak işaretlenmiştir!
    .a9 = Grafikleri sistemin için ayarlamayı unutma. '{ $gameinput-settings }'e basarak ayarları aç.
    .a10 = Başkalarıyla oynamak eğlencelidir! '{ $gameinput-social }'ya basarak kimlerin çevirimiçi olduğunu gör.
    ...
    .a14 = Vox World hala Pre-Alpha'da. Onu geliştirmek için her gün elimizden geleni yapıyoruz!
