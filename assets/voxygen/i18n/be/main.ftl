...
main-notice =
    Сардэчна запрашаем у альфа-версію Vox World!
    ...
    - Vox World распаўсюджваецца пад ліцэнзіяй GPL 3. Гэта значыць, што вы вольныя гуляць, мадыфікаваць ды распаўсюджваць
    гульню, як пажадаеце (пры ўмове, што вашыя мадыфікацыі таксама будуць распаўсюджвацца пад ліцэнзіяй GPL 3).

    - Vox World - гэта некамерцыйны грамадскі праект, і ўсе, хто над ім працуюць, - добраахвотнікі.
...
loading-tips =
    ...
    .a14 = Vox World пакуль у стадыі прэ-альфа. Мы імкнемся паляпшаць гульню кожны дзень!
