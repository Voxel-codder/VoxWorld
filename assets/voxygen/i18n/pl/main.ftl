...
main-notice =
    ...
    - Vox World jest objęte licencją typu open-source 'GNU GPLv3'.
    ...
    - Vox World jest projektem non-profit, w całości tworzonym przez wolontariuszy w wolnym czasie.
    Jeśli polubisz Vox World, zapraszamy cię do dołączenia do naszego zespołu! Nowi programiści, artyści, tłumacze i inni są zawsze mile widziani!

    Dziękujemy za przeczytanie tej notki i życzymy miłej gry!

    ~ Zespół Twórców Vox World
main-login_process =
...
loading-tips =
    ...
    .a14 = Vox World dalej jest w fazie Pre-Alpha. Staramy się ulepszać go dzień w dzień!
