...
object-v-coin = Vcoin
    .desc = Valuta usata in Vox World.
...
sprite-crafting_ing-cursed_bead = Perla Maledetta
    .desc = Quali magie sinistre potrebbero essere celate in questa antica perla mistica?
sprite-crafting_ing-golemite_slab = Lastra di Golemite
    .desc = Dopo essere stato riportato al suo antico splendore, questo materiale terroso si è indurito e ora è adatto per costruire delle armature.
sprite-crafting_ing-golem_core = Nucleo del Golem
    .desc = Un misterioso nucleo magico, capace di alimentare un antico costrutto guardiano.
sprite-crafting_ing-bloody_tear = Lacrima di Sangue
    .desc = Il sangue rappreso e concentrato delle innumerevoli vittime delle bestie.
sprite-crafting_ing-molten_core = Nucleo Fuso
    .desc = Spada liquida compatta forgiata nella grande fornace della terra.
sprite-crafting_ing-earthern_shard = Pezzo di Terracotta
    .desc = Un frammento indurito che un tempo faceva parte di un essere ceramico animato.
sprite-crafting_ing-alkahest = Alkahest
    .desc = Solvente alchemico.
sprite-crafting_ing-dwarven_battery = Batteria nanica
    .desc = Recipiente di energia magica.
sprite-mineral-ore-ancient_gold = Oro antico
    .desc = Un antico lingotto d'oro, imbevuto di energia magica.
