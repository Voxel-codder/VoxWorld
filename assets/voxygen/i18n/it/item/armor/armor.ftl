...
armor-hide-leather-pants = Pantaloni di pelle
    .desc = Veloce come il vento.
armor-hide-leather-shoulder = Spallacci di cuoio
    .desc = Il peso sulle tue spalle aumenta sempre di più. È il materiale... o la tua coscienza?
...
armor-misc-head-wanderers_hat = Cappello da viandante
    .desc = L'accessorio perfetto per chi si sente a casa sulle strade e sui sentieri di Vox World.
...
armor-hide-carapace-head = Kabuto Carapace
    .desc = Un trofeo che quasi eguaglia l'altezza del tuo ego.
armor-hide-leather-head = Copricapo di cuoio
    .desc = Il copricapo spesso mantiene i tuoi occhi perfettamente adattati alla notte.
armor-hide-primal-head = Cresta Primordiale
    .desc = Non è solo un trofeo, ma la cresta di un mostro.
