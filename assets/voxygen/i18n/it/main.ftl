...
main-notice =
    Benvenuto nella versione Alpha di Vox World!
    ...
    - Vox World è concesso in licenza con la licenza open-source GPL 3. Il che vuol dire che sei libero di giocare, modificare e ridistribuire il gioco come
     tu desideri (purché il lavoro che ne derivi sia sempre sotto licenza GPL 3).

    - Vox World è un progetto comunitario no-profit, e chiunque ci lavori sopra è un volontario.
    ...
    ~ Il team di sviluppo di Vox World
main-login_process =
    ...
    la pagina account di Vox World
...
loading-tips =
    ...
    .a8 = Inventario pieno di cibo? Prova a utilizzarlo per crearne di migliore!
    ...
    .a14 = Vox World è ancora in pre-alpha. Facciamo del nostro meglio per migliorarlo ogni giorno!
