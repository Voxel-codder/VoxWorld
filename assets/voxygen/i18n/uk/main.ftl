...
main-notice =
    Вітаємо в альфа-версії Vox World!
    ...
    - Vox World - це проект з відкритим кодом. Ви можете вільно грати, змінювати та поширювати гру відповідно до версії 3 загальнодоступної ліцензії GNU.

    - Vox World - це неприбутковий проект, і всі, хто над ним працюють - волонтери.
...
main-login_process =
    ...
    сторінці облікового запису Vox World
...
main-login-banned = Вас заблоковано з наступної причини: { $reason }
main-login-kicked = Вас вигнано з наступної причини: { $reason }
...
loading-tips =
    ...
    .a14 = Vox World все ще на стадії ранньої альфи. Ми стараємося кожного дня щоб робити покращення!
