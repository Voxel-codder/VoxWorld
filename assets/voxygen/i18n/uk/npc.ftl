...
npc-speech-villager_adventurous =
    .a0 = Я сподіваюся колись зробити власний планер.
    .a1 = Я хотів би досліджувати печери, коли стану сильнішим.
    .a2 = Я чув, що в печерах є золото, срібло та діаманти.
    .a3 = Як тільки я змайструю Кайло, я зможу видобувати руду щоб заробити більше грошей.
    .a4 = Мій тато розповідав мені, що в печерах живуть Тролі, Людожери та Оні.
    .a5 = Антилопи, Кельпі та коні - справді швидкі верхові тварини.
    .a6 = Це весело збирати червоні квіти, просто подивися на трав'яних ділянках.
    .a7 = Я люблю збивати стрілами яблука та кокоси з дерев.
    .a8 = Раптори та Дзьоборуби мають елегантні Гребені.
    .a9 = Я виймаю гострі ікла з Вовків і Шаблезубих.
    .a10 = Ти бачив коли-небудь, які потужні Клішні в Павуків?
    .a11 = У Жахорога та Мамонта справді міцні шкури.
    .a12 = Стережись крижаних осколків, що залишають по собі Крижаний Іклок, Рошвалр і Вендіго.
    .a13 = Я зістригаю шерсть з овець, кіз та альпак.
    .a14 = Для виготовлення торб ти можеш використати клейку нитку, яку можна отримати з павуків та повзунів.
    .a15 = Зазирни до Велетенських Дерев, якщо шукаєш живі ліани.
...
npc-speech-villager_conscientious =
    .a0 = Я не сиджу склавши руки. Завжди знайдеться робота.
    .a1 = Сподіваюся, скоро піде дощ. Це було б добре для врожаю.
    .a2 = Ми всі живемо в одному світі, тож маємо бути щедрими одне до одного.
npc-speech-villager_busybody =
    .a0 = Людям треба менше балакати і більше працювати.
npc-speech-villager_unconscientious =
    .a0 = Гадаю, час для другого сніданку!
    .a1 = Хотів би я щоб у моїй хаті не було так брудно. Але для цього мені потрібно було б прибратись! Ха-ха!
    .a2 = І куди це я подів ту штуковину...
    .a3 = Колись я б залюбки політав на повітряному кораблі.
    .a4 = Тобі ніколи не хотілося піти на спокій і просто колекціонувати сир?
npc-speech-villager_extroverted =
    .a0 = Ви не повірите, чим я займався цими вихідними!
    .a1 = Доброго вам раночку!
    .a2 = Що ви думаєте про таку погоду?
    .a3 = Я просто шаленію від сиру!
    .a4 = Не забудьте про крекери!
    .a5 = Я просто обожнюю гномський сир. Шкода, що я не вмію його робити.
    .a6 = Минулої ночі мені наснився дивовижний сон про сир. Що б це могло означати?
    .a7 = Я обожнюю мед! І терпіти не можу бджіл.
    .a8 = Як дерева, бджоли та зорі — ти тут на своєму місці.
npc-speech-villager_sociable =
    .a0 = Заходьте! Ми якраз збиралися поласувати сиром!
    .a1 = Хочете подивитися на мій сад? Ну, добре, можливо, іншим разом.
    .a2 = Подорожувати наодинці небезпечно, вам варто взяти з собою друга.
    .a3 = Дружбу можна здобути через взаємоповагу, спілкування та довіру.
    .a4 = Дружба варта більше, ніж весь Vcoin купця.
    .a5 = Вміння прощати себе та інших робить життя значно щасливішим.
