...
main-notice =
    ...
    - Vox World is open source. You are free to play, modify, and redistribute the game in accordance to version 3 of the GNU General Public license.
...
loading-tips =
    ...
    .a14 = Vox World is still in Pre-Alpha. We do our best to improve it every day!
