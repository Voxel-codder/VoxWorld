...
npc-speech-villager_adventurous =
    ...
    .a3 = Once I craft a pickaxe I can mine ore for Vcoin.
...
npc-speech-villager_sociable =
    ...
    .a4 = Friendship is worth more than all the Vcoin of a merchant.
...
npc-speech-villager_disagreeable =
    .a0 = If you've got something to say, be quick about it.
    .a1 = I can't remember the last time I had a decent conversation.
...
npc-speech-villager_cultist_alarm =
    ...
    .a17 = Die, cultist!
    .a18 = Your reign of terror will cease!
    .a19 = Here's for all that you've done!
    .a20 = I'll send you back to the darkness you came from!
...
npc-response-quest-escort-ask =
    .a0 = Could you lead me to { $dst }? I'll pay you { $coins } Vcoin! I need to get there in { $mins } minutes!
    .a1 = I want to go to { $dst } in the next { $mins } minutes. Could you take me there for { $coins } Vcoin?
...
npc-response-quest-slay-ask =
    .a0 = The people here are being terrorised by { $body }! It must be slain! I'll pay you { $coins } Vcoin for the job.
    .a1 = Not far from here, { $body } lurks. We can't live like this! { $coins } Vcoin are on offer if you'll do the deed!
npc-response-quest-slay-start =
    .a0 = I've marked the beast's last known location on your map.
    .a1 = I've marked your map so you know where to go.
npc-response-quest-slay-start_2 = If you can't find me, you can ask somebody else for directions.
