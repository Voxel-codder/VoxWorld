...
object-v-coin = Vcoin
    .desc = Valuta som används i Vox World.
...
sprite-crafting_ing-leather-rigid_leather = Styv läder
    .desc = Väger lite men är skiktad, perfekt för skydd.
sprite-crafting_ing-hide-animal_hide = Djurskinn
    .desc = Vanlig päls från de flesta djur. Blir läder.
sprite-crafting_ing-hide-rugged_hide = Tålig skinn
    .desc = Hållbar skinn från våldsamma varelser, omtyckt av läderarbetare.
sprite-grass-grass_long_5 = Långt gräs
    .desc = Grönare än en orchs nos.
sprite-crafting_ing-abyssal_heart = Avgrundshjärta
    .desc = Källan till Dagons kraft.
sprite-crafting_ing-hide-tough_hide = Tufft skinn
    .desc = Ett relativt tufft, grovt skinn. Blir läder.
sprite-crafting_ing-oil = Olja
