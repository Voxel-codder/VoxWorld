...
npc-speech-villager_adventurous =
    ...
    .a3 = När jag tillverkat en hacka kan jag gräva ut malm för Vcoin.
    ...
    .a8 = Raptors and axebeak have elegant crests.
    .a9 = Jag drar ut vassa huggtänder från vargar och sabretooths.
    ...
    .a13 = Jag rakar får, getter och alpackor för ull.
...
npc-speech-witness_theft =
    ...
    .a6 = Sluta annars kallar jag på vakterna.
...
npc-speech-pilot-where_heading_now =
    ...
    .a1 = Jag tar oss { $dir } om { $dst } först, sen { $ndir } om { $ndst }.
...
npc-speech-pilot-announce_next =
    .a0 = Hoppa ombord om du ska { $dir } om { $dst }!
...
npc-speech-where_are_we_going_wrong_profession =
    ...
    .a1 = Va? Varför ska jag skjutsa dig nånstans?
...
npc-response-quest-escort-ask =
    .a0 = Kan du leda mig till { $dst }? Jag betalar { $coins } Vcoin! Jag komma dit inom { $mins } minuter!
    .a1 = Jag vill gå till { $dst } inom { $mins } minuter. Kan du ta mig dit för { $coins } Vcoin?
...
npc-response-quest-slay-start_4 =
    ...
    .a1 = Lycka till! Din betalning väntar dig när du återkommer till mig!
...
npc-response-quest-slay-ask =
    .a0 = Folket här blir terroriserade av { $body }! Den måste besegras! Jag betalar dig { $coins } Vcoin för jobbet.
    .a1 = Inte långt härifrån smyger { $body } runt. Vi kan inte leva så här! { $coins } Vcoin är på bordet om du gör gärningen!
