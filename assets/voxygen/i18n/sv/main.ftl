...
main-notice =
    Välkommen till alfaversionen av Vox World!
    ...
    – Vox World är öppen källkod. Du får spela, modifiera, och sprida spelet vidare som du vill i enlighet med version 3 av GNU General Public License.

    – Vox World är ett ideellt community-projekt, och alla som jobbar på det är en volontär.
...
main-servers-persistence_error = Serverpersistensfel (troligtvis tillgångs-/karaktärs-datarelaterat): { $raw_error }
...
loading-tips =
    ...
    .a14 = Vox World är fortfarande i pre-alpha. Vi gör vårt bästa för att förbättra det varje dag!
