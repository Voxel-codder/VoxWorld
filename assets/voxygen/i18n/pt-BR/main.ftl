...
main-notice =
    Bem-vindo a versão alfa de Vox World!
    ...
    - Vox World é open source. Você é livre pra jogar, modificar e redistribuir desde que em acordo com a versão 3 da GNU General Public license.

    - Vox World é um projeto comunitário sem fins lucrativos, e todos que trabalham nele são voluntários.
...
main-login_process =
    ...
    a página de conta do Vox World
...
loading-tips =
    ...
    .a14 = Vox World ainda está no Pre-Alpha. Estamos nos empenhando ao máximo para melhorar a cada dia!
