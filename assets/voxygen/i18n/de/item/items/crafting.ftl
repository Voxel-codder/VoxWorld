...
sprite-flowers-pyrebloom = Glutrose
...
object-v-coin = Vcoin
    .desc = Währung, die in Vox World verwendet wird.
...
sprite-crafting_ing-golem_core = Golemkern
    .desc = Ein mysteriöser magischer Kern, welcher einst ein uraltes Wächter-Konstrukt antrieb.
sprite-crafting_ing-golemite_slab = Golemitplatte
    .desc = Nachdem es seinen früheren Glanz zurückerhalten hat, wurde dieses irdische Material stabil und geeignet für die Rüstungsherstellung.
sprite-crafting_ing-cursed_bead = Verfluchte Perle
