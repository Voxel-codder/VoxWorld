...
main-notice =
    Wilkommen in der Alpha-Version von Vox World!
    ...
    - Vox World ist Open Source. Du hast die Freiheit, das Spiel unter den Bedingungen der GPL-3-Lizenz zu spielen, zu verändern und weiterzuverbreiten.

    - Vox World ist ein Non-Profit Community Projekt und jeder Mitarbeiter entwickelt es als Hobby in seiner Freizeit.
...
loading-tips =
    ...
    .a14 = Vox World ist immernoch in der Pre-Alpha. Wir tun unser Bestes, um es jeden Tag ein Stück besser zu machen!
