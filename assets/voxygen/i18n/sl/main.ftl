...
main-notice =
    Dobrodošel_a v alfa različico Vox World!
    ...
    - Vox World je odprtokoden. Igro lahko prostor igraš, spreminjaš in deliš naprej v skladu z različico 3 Splošne javne licence GNU.

    - Vox World je neprofiten javni projekt. Vsi, ki se ukvarjamo z njim, smo prostovoljci.
...
loading-tips =
    ...
    .a14 = Vox World je še vedno v zgodnjem razvoju. Vsak dan ga izboljšujemo!
