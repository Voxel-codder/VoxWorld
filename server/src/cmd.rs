...
fn handle_time(
    ...
    let new_time = match time.as_deref() {
        ...
        None => {
            ...
            // time which, obviously, would be Vox World. By that time, the inescapable
            ...
            // accordingly. When booting up Vox World for the first time in 337,241
            ...
            // skeletons of the Vox World team, measuring various attributes of their
            ...
            // post-human hominid employed by the 'Vox World Revival Corp' (no doubt we
            ...
            // decode this great mystery. Rejoice! The Vox World Revival Corp. may now
