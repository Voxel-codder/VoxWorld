...
#[derive(Parser)]
#[command(
    name = "Vox World server TUI",
    version = common::util::DISPLAY_VERSION.as_str(),
    about = "The Vox World server tui allows sending commands directly to the running server.",
    author = "The Vox World team",
)]
...
#[derive(Parser)]
#[command(
    name = "Vox World server CLI",
    version = common::util::DISPLAY_VERSION.as_str(),
    about = "The Vox World server cli provides an easy to use interface to start a Vox World server.",
    author = "The Vox World team",
)]
pub struct ArgvApp {
    #[arg(long, short)]
